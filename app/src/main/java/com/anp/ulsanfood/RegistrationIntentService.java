...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        // GCM Instance ID의 토큰을 가져오는 작업이 시작되면 LocalBoardcast로 GENERATING 액션을 알려
        // ProgressBar가 동작하도록 한다.
        ...
        try {
            synchronized (TAG) {
                // GCM 앱을 등록하고 획득한 설정파일인 google-services.json을 기반으로 SenderID를
                // 자동으로 가져온다.
//                String default_senderId = getString(R.string.gcm_defaultSenderId);
                String default_senderId = "496060468342";
