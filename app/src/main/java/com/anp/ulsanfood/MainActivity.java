...
import static com.anp.ulsanfood.ShopListFragment.adminFlag;
...
public class MainActivity extends BaseActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private com.anp.ulsanfood.BackPressCloseHandler backPressCloseHandler;
    ...
    public static final String APP_ID = "ulsan";
...
//        btnSale = (ImageView)findViewById(R.id.main_sale);
        ...
        // new com.anp.ulsanfood.gcm.Timer(new TimerListener() {
        //
        // public void onTick() {
        // setHttpRequest();
        // }
...
//                }
    ...
    protected void onDestroy() {
        ...
        // 레이지이미지로더 캐시 정리
        new com.anp.ulsanfood.lazylist.ImageLoader(mContext).clearCache();
    }
