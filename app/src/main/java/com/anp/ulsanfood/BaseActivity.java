...
import com.anp.ulsanfood.menu.Fragment1;
import com.anp.ulsanfood.menu.Fragment2;
import com.anp.ulsanfood.menu.Fragment3;
import com.anp.ulsanfood.menu.Fragment4;

import static com.anp.ulsanfood.DataBaseOpenHelper.TABLE_NAME;
import static com.anp.ulsanfood.Utils.getDisplayWidthSize;
...
//        public static final boolean TTS_MODE = true;
    ...
    protected void onStop() {
        super.onStop();
        new com.anp.ulsanfood.lazylist.ImageLoader(this).clearCache();
        // toggle();
...
//    }
    ...
    public static String getMarketVersionName(Context context) {
        ...
        try {
            ...
            String query = "com.anp.ulsanfood";
