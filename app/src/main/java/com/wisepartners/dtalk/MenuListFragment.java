...
public class MenuListFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(com.wisepartners.dtalk.R.layout.list, null);
    }
...
//        }
    ...
    public class SampleAdapter extends ArrayAdapter<SampleItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = LayoutInflater.from(getContext()).inflate(com.wisepartners.dtalk.R.layout.row,
                        null);
            }
            ImageView icon = (ImageView)convertView.findViewById(com.wisepartners.dtalk.R.id.row_icon);
            icon.setImageResource(getItem(position).iconRes);
            TextView title = (TextView)convertView.findViewById(com.wisepartners.dtalk.R.id.row_title);
