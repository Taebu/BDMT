...
import com.wisepartners.dtalk.menu.Fragment1;
import com.wisepartners.dtalk.menu.Fragment2;
import com.wisepartners.dtalk.menu.Fragment3;
import com.wisepartners.dtalk.menu.Fragment4;

import static com.wisepartners.dtalk.DataBaseOpenHelper.TABLE_NAME;
import static com.wisepartners.dtalk.Utils.getDisplayWidthSize;
...
//        public static final boolean TTS_MODE = true;
    ...
    protected void onStop() {
        super.onStop();
        new com.wisepartners.dtalk.lazylist.ImageLoader(this).clearCache();
        // toggle();
...
//    }
    ...
    public static String getMarketVersionName(Context context) {
        ...
        try {
            ...
            String query = "com.wisepartners.dtalk";
