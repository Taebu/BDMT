...
import static com.wisepartners.dtalk.ShopListFragment.adminFlag;
...
public class MainActivity extends BaseActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    public static final String APP_ID = "dtalk";
...
//        btnSale = (ImageView)findViewById(R.id.main_sale);
        ...
        // new com.wisepartners.dtalk.gcm.Timer(new TimerListener() {
        //
        // public void onTick() {
        // setHttpRequest();
        // }
...
//                }
    ...
    protected void onDestroy() {
        ...
        // 레이지이미지로더 캐시 정리
        new com.wisepartners.dtalk.lazylist.ImageLoader(mContext).clearCache();
    }
